...
const SLIDES: OnboardingSlide[] = [
  ...
  },
  {
    ...
    features: ['6 unique PDUFA-themed bosses', 'Exploit boss weaknesses for 2× damage', 'Earn XP, coins & rare loot'],
  ...
  },
  {
    ...
    features: ['Post-dismissal re-check timer', 'Morning routine quests for bonus XP', '20 levels from Thrall to Odin\'s Eye'],
    bgAccent: COLORS.frost,
  },
  {
    emoji: '👁️',
    title: 'Powered by ODIN Intelligence',
    subtitle: 'From the creators of pdufa.bio',
    features: ['Biotech Mode — PDUFA trivia & boss lore', 'Share victories & earn coins', 'Join the ODIN platform waitlist'],
